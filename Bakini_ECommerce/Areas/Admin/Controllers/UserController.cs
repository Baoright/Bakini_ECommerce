    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            var usersWithRoles = await
                (
                from u in _databaseContext.Users
                join ur in _databaseContext.UserRoles on u.Id equals ur.UserId
                join r in _databaseContext.Roles on ur.RoleId equals r.Id
